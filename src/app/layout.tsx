...
import { MobileOptimizer, MobileThemeFix } from '@/components/shared';
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `
              (function() {
                try {
                  // Immediately set dark theme and background to prevent white flash
                  ...
                  // Set body background immediately if it exists
                  if (body) {
                  ...
                  var theme = localStorage.getItem('quickshare-theme');
                  if (!theme) {
                  ...
                  if (theme === 'system') {
                    ...
                    // Keep dark background even for light system theme on mobile
                    var isMobile = window.innerWidth <= 768 || /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);
                    if (isMobile && systemTheme === 'light') {
                      root.style.backgroundColor = 'hsl(222.2 84% 4.9%)';
                      if (body) {
                        body.style.backgroundColor = 'hsl(222.2 84% 4.9%)';
                      }
                    ...
                    // Force dark background on mobile regardless of theme
                    var isMobile = window.innerWidth <= 768 || /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);
                    if (isMobile) {
                      root.style.backgroundColor = 'hsl(222.2 84% 4.9%)';
                      if (body) {
                  ...
                  // Fallback to dark theme with background
